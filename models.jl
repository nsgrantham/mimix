...
using RCall
R"library(GIGrvg)"  # will soon move to a pure Julia solution after I finish
                    # a pull request to Distributions.jl which introduces the
                    # GeneralizedInverseGaussian distribution
...
###  MIMIX w/o Factors (a loose equivalent to univariate mixed models)
